...
/*
$finded_Arr1 = array($word); // Массив начальных форм слова (именит. падеж, неопределенная форма глагола и т.д.). Они м.б. ошибочными, их следует проверить
...
$finded_Arr1 = array_values(($finded_Arr1));
*/

// Массив начальных форм слова (именит. падеж, неопределенная форма глагола и т.д.). Они м.б. ошибочными, их следует проверить
